...
3. Run [`train_sa_pdd_lorenz96.py`](./scripts/train_sa_pdd_lorenz96.py) to train a diffusion model: `$ python3 scripts/train_sa_pdd_lorenz96.py --device cuda:0 --config_path "$PWD/configs/lorenz96_sa_pdd.yml"`
...
3. Run [`train_sa_pdd_kolmogorov_flow.py`](./scripts/train_sa_pdd_kolmogorov_flow.py) to train a diffusion model: `$ python3 scripts/train_sa_pdd_kolmogorov_flow.py --device cuda:0 --config_path "$PWD/configs/kolmogorov_flow_sa_pdd.yml"`
